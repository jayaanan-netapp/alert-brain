...
from transformers import TFBertModel, GPT2Tokenizer
from sklearn.metrics import classification_report, confusion_matrix

# Load BERT model and tokenizer
gpt2_model = TFBertModel.from_pretrained('gpt2')
...
bert_output = gpt2_model(input_ids_input, attention_mask=attention_mask_input)[1]  # Use pooled output
...
print("Test Messages:")
for message, true_category, predicted_category in zip(eval_messages, eval_true_categories, eval_predicted_categories):
